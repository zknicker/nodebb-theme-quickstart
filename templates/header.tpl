...
<body class="{bodyClass} skin-{config.bootswatchSkin}">
	...
	<main id="panel">
		<div class="giant-header header navbar navbar-default navbar-fixed-top" id="header-menu" component="navbar">
			<div class="container" widget-area="header-content">
				...
				<div id="nav-dropdown" class="hidden-xs">
					...
					<ul class="nav navbar-nav navbar-right pagination-block visible-lg visible-md">
						<li class="dropdown">
							...
							<a href="#" class="dropdown-toggle dropdown-toggle-pagination" data-toggle="dropdown">
